...
**계산파괴역학 시리즈:** 7편 중 1편 · [다음: XFEM →](../xfem-crack-through-mesh/)
...
**2. [XFEM은 어떻게 균열이 요소망을 가로질러 지나가게 하는가?](../xfem-crack-through-mesh/)**  
일반 유한요소로 표현할 수 없는 변위 점프와 균열선단 운동학을 어떻게 표현하는지 설명한다.

**3. [왜 XFEM을 무요소법으로 확장했는가?](../xefg-why-meshfree/)**  
같은 확충 개념이 유한요소에서 입자의 영향영역으로 어떻게 옮겨가는지 설명한다.

**4. [여러 균열은 어떻게 분기하고 만나 파괴 네트워크를 만드는가?](../multiple-cracks-fracture-network/)**  
